...
cd /users/rushworth/gwr089/scratch/Generalization-Preprocess/zeno/structural/mprage

echo "Copying from backup to structural_reset.nii.gz"
cp ZENO_20221207_001_100_Arithmetic_Mean_MEAN_MPRAGE.nii.gz structural_reset.nii.gz
