...
# for subj in $subjList ; do
  ...
  $cmd sh $MRCATDIR/core/struct_macaque.sh \
    --all\
    --subjdir=/Volumes/NHP/BBBO/Tim/work/preTUS1 \
    --structimg=/Volumes/NHP/BBBO/Tim/work/preTUS1/TIM_preTUS1_mp2rage_INV2.nii.gz \
    --refspace=Tim \
    --refimg=/Volumes/Monkey/structural_new/Tim/Tim.nii.gz
    #--refspace=F99 \
