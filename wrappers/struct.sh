...
# for subj in $subjList ; do
  ...
  $cmd sh $MRCATDIR/core/struct_macaque.sh \
    --all \
    --subjdir=/well/rushworth/projects/nhp/users/simone/struct/zach \
    --structdir=/well/rushworth/projects/nhp/users/simone/struct/zach \
    --transdir=/well/rushworth/projects/nhp/users/simone/struct/zach/transform \
    --refspace=F99 \
